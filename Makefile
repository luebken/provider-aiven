...
PROJECT_NAME := provider-aiven
PROJECT_REPO := github.com/luebken/$(PROJECT_NAME)

export TERRAFORM_VERSION := 1.3.3

export TERRAFORM_PROVIDER_SOURCE := aiven/aiven
...
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-aiven_v3.8.0
...
xpkg.build.provider-aiven: do.build.images
